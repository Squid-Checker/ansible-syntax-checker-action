...
LABEL "repository"="https://github.com/Squid-Checker/ansible-syntax-checker-action"
LABEL "homepage"="https://github.com/Squid-Checker/ansible-syntax-checker-action"
